          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  type="email"
                  defaultValue="john.doe@softinterio.com"
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                />
              </div>
              <div>
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  rows={3}
                  defaultValue="Senior Interior Designer with 10+ years of experience in residential and commercial projects."
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                />
              </div>
            </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  type="text"
                  defaultValue="SoftInterio Design Studio"
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                />
              </div>
              <div>
              ...
              <div className="md:col-span-2">
                ...
                <input
                  type="text"
                  defaultValue="123 Design Street, Creative District, NYC 10001"
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                />
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-sm text-gray-600">
                    Automatically save project drafts
                  </div>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
