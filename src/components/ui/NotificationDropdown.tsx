  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="relative p-2.5 text-slate-400 hover:text-slate-500 hover:bg-slate-100 rounded-lg transition-all duration-200"
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-72 bg-white rounded-lg border border-slate-200 shadow-lg z-50">
