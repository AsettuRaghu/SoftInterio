-- Migration: Fix Lead to Project Conversion Flow
-- Issue: create_project_from_lead RPC was using incorrect column names (start_date instead of expected_start_date)
-- Date: 2026-01-11

-- =====================================================
-- Fix: Recreate create_project_from_lead RPC function (version 1)
-- =====================================================
-- This is the older version of the function. Replace the incorrect start_date with expected_start_date
...
-- =====================================================
-- Fix: Recreate create_project_from_lead RPC function (version 2 - with extended parameters)
-- =====================================================
-- This is the newer version with project_manager_id, priority, and target date parameters
